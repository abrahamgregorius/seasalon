    ...
    <form class="w-full flex flex-col" action="" method="POST">
        ...
        <div class="form-controls space-y-2">
            ...
            <div class="form-control flex flex-col">
                ...
                <select class="border border-slate-600 rounded px-3 py-1" name="branch_id" id="branch">
            ...
            <div class="form-control flex flex-col">
                ...
                <input required class="border border-slate-600 rounded px-3 py-1"  type="time" id="time" name="time">
            </div>
